...
*/
 ...
 function  update_cus(){
  ...
  fire_ajax_submit(search["customerId"]);
   ...
   showAndDismissAlert('success', 'Customer Updated Successful!');
        ...
        error: function (e) {
               		...
               		showAndDismissAlert('danger', 'Error in Updating Customer!!! ');
